...
local function make_rsl_definition(rsl_registration)
    ...
    if rsl_definition.data.quality_cycling and rsl_definition.data.deterministic_result == nil then
    ...
    if rsl_definition.data.quality_change and rsl_definition.data.deterministic_result then
        rsl_definition.data["selector"] = "quality_upscale"
